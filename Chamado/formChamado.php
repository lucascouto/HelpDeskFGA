<div id="Chamado">
    ...
    <form action="" method="GET">
        ...
        <input type="button" name="cancelarchamado" value="CANCELAR" id ="cancela-chamado" class="botaochamado botaochamado-green" onclick="limpaValidacaochamado();limpaForm();"/>
        <input type="submit" name="enviar" value="ENVIAR" class="botaochamado botaochamado-blue" />
    </form>
</div>